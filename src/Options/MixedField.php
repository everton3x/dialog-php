...
class MixedField
{
    ...
    public function __construct(string $label, array $label_pos, string $field, array $field_pos, int $flen, int $ilen, int $itype = 0)
    {
        $this->label = $label;
